"""
Django settings for demoapp3_3 project.
...
WSGI_APPLICATION = 'demoapp3_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demoapp3_3 API",
    "DESCRIPTION": "API documentation for demoapp3_3 App",
    "VERSION": "v1",
}
